...
function renderApp(fetch: ReturnType<typeof createFetchStub>['fetch'], initialEntries: string[]) {
...
describe('App', () => {
  ...
  it('renders GroupDetailPage at /groups/:groupId', async () => {
    ...
    stub.queueResponse('GET', '/api/groups/g1', {
      status: 200,
      body: { id: 'g1', name: 'Trip', currency: 'USD', createdAt: '2026-09-01T00:00:00.000Z', members: [], expenses: [] },
    })
